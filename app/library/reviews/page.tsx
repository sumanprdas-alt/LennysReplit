...
export default function Page() {
  return <Shell><div className="flex-1 p-8 max-w-[640px]">
    <div className="flex items-center gap-3 fade-up">
      ...
      <h2 className="font-display text-[24px] font-normal">Product Reviews</h2>
    ...
    <p className="text-[14px] mt-4 leading-relaxed fade-up-1" style={{ color:"var(--t3)" }}>Structured teardowns of real products by the builders who made them. Learn what worked, what didn't, and why.</p>
    <div className="mt-6 rounded-xl p-5 fade-up-2" style={{ background:"var(--bg2)", border:"1px solid var(--border)" }}>
      <p className="text-[13px] leading-relaxed" style={{ color:"var(--t3)" }}>This module is being built right now. In the meantime, the Sage can help you think through any product review challenge.</p>
