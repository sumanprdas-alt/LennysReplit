...
const MODULES = [
  { n: "Product Teardowns", d: "Learn from real products", ico: "🔍" },
  { n: "Review Templates", d: "Structured critique", ico: "📝" },
  { n: "Comparison Analysis", d: "Side-by-side evaluations", ico: "⚖️" },
  { n: "Best Practices", d: "Patterns that work", ico: "✅" },
];
...
export default function Page() {
  return <Shell><div className="flex-1 p-7 max-w-[640px]">
    <div className="flex items-center gap-2 fade-up">
      ...
      <h2 className="font-display text-[22px] font-normal">Product Reviews</h2>
    ...
    <p className="text-[13px] mt-3 leading-relaxed fade-up-1" style={{ color:"var(--t3)" }}>Structured product reviews and teardowns from experienced builders.</p>
