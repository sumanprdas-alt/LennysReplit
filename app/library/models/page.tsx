...
const MODULES = [
  { n: "First Principles", d: "Break decisions to fundamentals", ico: "🔬" },
  { n: "Trade-off Matrices", d: "Map competing priorities", ico: "⚖️" },
  { n: "Decision Journals", d: "Track reasoning over time", ico: "📓" },
  { n: "Pattern Library", d: "Common failure modes", ico: "🔄" },
];
...
export default function Page() {
  return <Shell><div className="flex-1 p-7 max-w-[640px]">
    <div className="flex items-center gap-2 fade-up">
      ...
      <h2 className="font-display text-[22px] font-normal">Mental Models</h2>
    ...
    <p className="text-[13px] mt-3 leading-relaxed fade-up-1" style={{ color:"var(--t3)" }}>Frameworks and thinking tools extracted from the world's best builders.</p>
