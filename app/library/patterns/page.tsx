...
export default function Page() {
  return <Shell><div className="flex-1 p-8 max-w-[820px] mobile-full">
    ...
    <p className="text-[14px] mt-4 leading-relaxed fade-up-1" style={{ color:"var(--t3)" }}>Decision archetypes and anti-patterns from hundreds of founders. See which patterns match yours.</p>
    <div className="mt-6 rounded-xl p-5 fade-up-2" style={{ background:"var(--bg2)", border:"1px solid var(--border)" }}>
      <p className="text-[13px] leading-relaxed" style={{ color:"var(--t3)" }}>This module is being built right now. In the meantime, the Sage can help you think through any founder pattern challenge.</p>
