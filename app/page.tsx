...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: "var(--bg)", color: "var(--t1)" }}>
      ...
      <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, rgba(28,28,26,0.82) 0%, rgba(28,28,26,0.68) 40%, rgba(28,28,26,0.9) 100%)", pointerEvents: "none" }} />
